...
public class MainActivity extends AppCompatActivity {
    ...
    public void onButton1Click(View view) {showSurnameOnButton("Никифоров", (Button) view);}

    public void onButton2Click(View view) {showSurnameOnButton("Никифоров", (Button) view);}

    public void onButton3Click(View view) {showSurnameOnButton("Никифоров", (Button) view);}
